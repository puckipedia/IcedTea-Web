...
public class ResourceUrlCreatorTest extends NoStdOutErrTest{
    ...
    private URL getResultUrl(final String url, final VersionString version, final boolean usePack /*use pack.gz suffix*/, final boolean useVersion /*use version suffix*/) throws MalformedURLException {
        final Resource resource = Resource.createResource(new URL(url), version, null, null, new UpdateOptions(UpdateCheck.ALWAYS, true));
    ...
    private URL getResultUrl(final String url, final VersionString version, final DownloadOptions downloadOptions) throws MalformedURLException {
        Resource resource = Resource.createResource(new URL(url), version, null, null, new UpdateOptions(UpdateCheck.ALWAYS, true));
    ...
    public void findBestUrltest() throws Exception {
        ...
        try {
            ...
            Resource r1 = Resource.createResource(testServer.getUrl(fileForServerWithHeader.getName()), null, null, UpdatePolicy.NEVER, new UpdateOptions(UpdateCheck.ALWAYS, true));
            Resource r2 = Resource.createResource(testServerWithBrokenHead.getUrl(fileForServerWithoutHeader.getName()), null, null, UpdatePolicy.NEVER, new UpdateOptions(UpdateCheck.ALWAYS, true));
            Resource r3 = Resource.createResource(testServer.getUrl(versionedFileForServerWithHeader.getName()), VersionString.fromString("1.0"), null, UpdatePolicy.NEVER, new UpdateOptions(UpdateCheck.ALWAYS, true));
            Resource r4 = Resource.createResource(testServerWithBrokenHead.getUrl(versionedFileForServerWithoutHeader.getName()), VersionString.fromString("1.0"), null, UpdatePolicy.NEVER, new UpdateOptions(UpdateCheck.ALWAYS, true));
