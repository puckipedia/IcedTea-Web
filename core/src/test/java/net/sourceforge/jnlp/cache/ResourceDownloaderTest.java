...
public class ResourceDownloaderTest extends NoStdOutErrTest {
    ...
    private Resource setupResource(String fileName, String text) throws IOException {
        ...
        Resource resource = Resource.createResource(url, null, null, UpdatePolicy.NEVER, new UpdateOptions(UpdateCheck.ALWAYS, false));
        return resource;
    }
    ...
    public void testDownloadPackGzResource() throws IOException {
        ...
        Resource resource = Resource.createResource(downloadServer.getUrl("download-packgz.jar"), null, new DownloadOptions(true, false), UpdatePolicy.NEVER, new UpdateOptions(UpdateCheck.ALWAYS, false));
    ...
    public void testDownloadVersionedResource() throws IOException {
        ...
        Resource resource = Resource.createResource(url, VersionString.fromString("1.0"), new DownloadOptions(false, true), UpdatePolicy.NEVER, new UpdateOptions(UpdateCheck.ALWAYS, false));
    ...
    public void testDownloadVersionedPackGzResource() throws IOException {
        ...
        Resource resource = Resource.createResource(downloadServer.getUrl("download-packgz.jar"), VersionString.fromString("1.0"), new DownloadOptions(true, true), UpdatePolicy.NEVER, new UpdateOptions(UpdateCheck.ALWAYS, false));
    ...
    public void testDownloadNotExistingResourceFails() throws IOException {
        Resource resource = Resource.createResource(new URL(downloadServer.getUrl() + "/notexistingfile"), null, null, UpdatePolicy.NEVER, new UpdateOptions(UpdateCheck.ALWAYS, false));
