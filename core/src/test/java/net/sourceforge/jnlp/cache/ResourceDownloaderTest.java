...
public class ResourceDownloaderTest extends NoStdOutErrTest {
    ...
    public void findBestUrltest() throws Exception {
        ...
        try {
            ...
            Resource r1 = Resource.createResource(testServer.getUrl(fileForServerWithHeader.getName()), null, UpdatePolicy.NEVER, new UpdateOptions(UpdateCheck.ALWAYS, true));
            Resource r2 = Resource.createResource(testServerWithBrokenHead.getUrl(fileForServerWithoutHeader.getName()), null, UpdatePolicy.NEVER, new UpdateOptions(UpdateCheck.ALWAYS, true));
            Resource r3 = Resource.createResource(testServer.getUrl(versionedFileForServerWithHeader.getName()), VersionString.fromString("1.0"), UpdatePolicy.NEVER, new UpdateOptions(UpdateCheck.ALWAYS, true));
            Resource r4 = Resource.createResource(testServerWithBrokenHead.getUrl(versionedFileForServerWithoutHeader.getName()), VersionString.fromString("1.0"), UpdatePolicy.NEVER, new UpdateOptions(UpdateCheck.ALWAYS, true));
    ...
    private Resource setupResource(String fileName, String text) throws IOException {
        ...
        Resource resource = Resource.createResource(url, null, UpdatePolicy.NEVER, new UpdateOptions(UpdateCheck.ALWAYS, false));
        return resource;
    }
    ...
    public void testDownloadPackGzResource() throws IOException {
        ...
        Resource resource = Resource.createResource(downloadServer.getUrl("download-packgz.jar"), null, UpdatePolicy.NEVER, new UpdateOptions(UpdateCheck.ALWAYS, false));
    ...
    public void testDownloadVersionedResource() throws IOException {
        ...
        Resource resource = Resource.createResource(url, VersionString.fromString("1.0"), UpdatePolicy.NEVER, new UpdateOptions(UpdateCheck.ALWAYS, false));
    ...
    public void testDownloadVersionedPackGzResource() throws IOException {
        ...
        Resource resource = Resource.createResource(downloadServer.getUrl("download-packgz.jar"), VersionString.fromString("1.0"), UpdatePolicy.NEVER, new UpdateOptions(UpdateCheck.ALWAYS, false));
    ...
    public void testDownloadNotExistingResourceFails() throws IOException {
        Resource resource = Resource.createResource(new URL(downloadServer.getUrl() + "/notexistingfile"), null, UpdatePolicy.NEVER, new UpdateOptions(UpdateCheck.ALWAYS, false));
