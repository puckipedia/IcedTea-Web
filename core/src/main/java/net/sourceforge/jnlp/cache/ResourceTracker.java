...
public class ResourceTracker {
    ...
    public void addResource(URL location, final VersionString version, final DownloadOptions options, final UpdatePolicy updatePolicy, final UpdateOptions updateOptions) {
        ...
        Resource resource = Resource.createResource(location, version, downloadOptions, updatePolicy, updateOptions);
        ...
        // if unnecessary.
        initResourceFromCache(resource);
     ...
     *
     * @param resource resource to init from cache
     */
    private void initResourceFromCache(final Resource resource) {
